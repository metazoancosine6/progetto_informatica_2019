<html>
    ...
    <body onload="cambiaMatricola();cambiaNome();cambiaCognome();cambiaPassword()">
          ...
          <form action="" method="POST">
            <?php
              ...
              $query = "SELECT id_meccanico,nome_m, cognome_m "
                      ...
                      echo "<select id='selezionato' name='selezionato' onchange='cambiaMatricola();cambiaNome();cambiaCognome();cambiaPassword()'>";//Creazione select per selezionare il meccanico al quale cambiare i dati
				...
				<tr>
					<td style="width:3%">
						<table>
							...
							<tr>
								<td><p>Password: </p></td><td><p id="password_v"></p></td>
							</tr>
						</table>
					</td>
					...
					<td style="width:50%">
						<table>
							...
							<tr>
								<td><p>Nuova password: </p></td><td style="width:50%"><input type="password" id="password" name="password" minlegth="1" maxlength="15" required></td>
							</tr>
						</table>
					</td>
				</tr>
