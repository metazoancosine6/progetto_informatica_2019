...
(201, '1976-11-10', 'ACOZAD28X17H929A', 'gvrbreb', 'AEREWVW', '44458', '929-5483 Vulputate Rd.', 352, NULL, ''),
...
(301, '2019-05-05', 'cccccccccccccccc', 'bbb', 'aaa', '00100', 'via po', 56, '7845698213', 'b@b.it');
...
CREATE TABLE `meccanico` (
  ...
  `pass_meccanico` varchar(50) NOT NULL,
...
CREATE TABLE `registrazione` (
  ...
  `password` varchar(50) NOT NULL,
  `stato_reg` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
